...
///import files from '../assets/filesBase64';
 ...
 class ProfileScreen extends React.Component {
   constructor(props){
     super(props)
     this.state={
      userId:this.props.route.params.to_user_id, 
      data:'',
      name:'',
      adress:'',
      email:'',
  ...
  await request.open('GET', 'http://10.0.2.2:80/Api/profile.php?userId='+this.props.route.params.to_user_id);
  await request.send();
    ...
    <View style={styles.container}>
     <Header backgroundColor={'#08d4c4'}
      ...
      onPress={()=>this.props.navigation.pop()}
       />}
      centerComponent={{ text: 'profile', style: { color: '#fff', fontSize:24,fontWeight:'bold' } }}
      />
